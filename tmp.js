export default {
    ...
    format: (value) => {
        if (switcher.getSign()) return format.currency(value, {decimal: 2})
        return format.format(value, {decimal: 0})
    },
            ...
            "dataSource": {
                ...
                "dataset": [
                    ...
                    },
                    {
                        ...
                        "legendIconBgColor": "${ui.color.set[2]}"
                    }
